...
```js
https://cdn.jsdelivr.net/gh/hchiam/draggable@3.4.2/makeElementDraggable.js
https://cdn.jsdelivr.net/gh/hchiam/draggable@3.4.2/makeElementDraggableAndEditable.js
```
...
```html
<script
  src="https://cdn.jsdelivr.net/gh/hchiam/draggable@3.4.2/makeElementDraggable.js"
...
```html
<script
  src="https://cdn.jsdelivr.net/gh/hchiam/draggable@3.4.2/makeElementDraggableAndEditable.js"
